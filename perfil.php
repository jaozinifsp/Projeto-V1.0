...
<body>
            ...
            <nav>  
                <div class="nav-wrapper">
                    ...
                    <ul id="nav-mobile" class="right hide-on-med-and-down">
                        <li>
                            <div id="login" style="text-align: right;"><span>Bem-vindo <?php echo $_SESSION['nome']; ?>!</span> <a href="php/logout.php">Sair</a>
                            </div></li>
                    </ul>
                </div>
            </nav>
    ...
    <!-- cards -->
    <section id="jogos">
            <li><a class="waves-effect waves-light btn modal-trigger" href="uploads.php">Dilvulgue seu Projeto</a></li>
        <div class="cards">
            <div class="row">
